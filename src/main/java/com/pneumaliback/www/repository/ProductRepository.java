...
public interface ProductRepository extends JpaRepository<Product, Long> {
       // === Actifs ===
       @Query("SELECT p FROM Product p LEFT JOIN FETCH p.width LEFT JOIN FETCH p.profile LEFT JOIN FETCH p.diameter LEFT JOIN FETCH p.brand WHERE p.active = true")
       Page<Product> findByActiveTrue(Pageable pageable);

       @Query("SELECT p FROM Product p LEFT JOIN FETCH p.width LEFT JOIN FETCH p.profile LEFT JOIN FETCH p.diameter LEFT JOIN FETCH p.brand WHERE p.id = :id")
       ...
       @Query("SELECT DISTINCT p FROM Product p LEFT JOIN FETCH p.width LEFT JOIN FETCH p.profile LEFT JOIN FETCH p.diameter LEFT JOIN FETCH p.brand WHERE p.active = true AND "
                     +
       ...
       @Query("SELECT DISTINCT p FROM Product p LEFT JOIN FETCH p.width LEFT JOIN FETCH p.profile LEFT JOIN FETCH p.diameter LEFT JOIN FETCH p.brand WHERE p.active = true ORDER BY SIZE(p.orderItems) DESC")
       ...
       // ===
       @Query("SELECT DISTINCT p FROM Product p LEFT JOIN FETCH p.width LEFT JOIN FETCH p.profile LEFT JOIN FETCH p.diameter LEFT JOIN FETCH p.brand WHERE p.active = true AND p.stock > 0 AND "
                     +
       ...
       @Query("SELECT DISTINCT p FROM Product p LEFT JOIN FETCH p.width LEFT JOIN FETCH p.profile LEFT JOIN FETCH p.diameter LEFT JOIN FETCH p.brand")
