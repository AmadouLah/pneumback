...
public interface PromotionRepository extends JpaRepository<Promotion, Long> {
    ...
    Optional<Promotion> findActivePromotionByCode(@Param("code") String code,
    ...
    List<Promotion> findPromotionsExpiringBetween(@Param("startDate") LocalDate startDate,
    ...
    List<Promotion> findByInfluenceurId(Long influenceurId);
